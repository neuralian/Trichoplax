# importPlacozoanData.jl
# Reads .csv file created by PlacozoanStalker 
...
# read data file
fileName = "PlacozoanStalkerV2.0 2022-02-19 20.25.csv" #PlacozoanStalkerV2.0 2022-02-17 15.42.csv"
RawData = dropmissing(CSV.read(fileName, DataFrame))
# 

# number of reps is the last entry in column 1
Nreps = Int64(RawData[:,1][end])

# rows per rep (number of frames in each rep)
Nframes = Int64(size(RawData)[1]/Nreps)
