...
function observerStats(prey::Placozoan, predator::Placozoan)
  ...
  RCDF = fill(0.0, prey.observer.maxRange)
  ...
  for j in -prey.observer.maxRange:prey.observer.maxRange
      d = 1+Int64(round(sqrt(i^2 + j^2)))     # quantized distance to world location
      Θ = 201 + Int64(round(atan(j,i)*200/π)) # quantized angle 0-400
  ...
  QΘ = [ ACDF[3] ACDF[11] ACDF[101] ACDF[201] ACDF[300] ACDF[390] ACDF[398]].*360/400 .- bearing
